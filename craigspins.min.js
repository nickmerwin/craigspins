(function(){var g=Math.floor($(window).width()/237);$(window).resize(function(){$("body").css({paddingLeft:($(window).width()-237*g)/2})});var p=$("body").html(),d=$("<form/>",{id:"qForm"}),b=$("<input/>",{id:"q"}).css({cssFloat:"left",width:183,border:"1px solid",lineHeight:1.3,boxShadow:"0 1px #fff, inset 0 1px rgba(34,25,25,0.05)","-moz-box-shadow":"0 1px #fff, inset 0 1px rgba(34,25,25,0.05)","-webkit-box-shadow":"0 1px #fff, inset 0 1px rgba(34,25,25,0.05)",fontSize:13,borderColor:"#C2C0C0 #CCCACA #D1CFCF",
...
b=function(){try{for(var f=$("#q").val(),a=0;a<g;a++)h[a].html("");j=0;k=f;l(f,0);return!1}catch(e){return console.log(e),!1}};d.submit(b);c.click(b);$("body").css({paddingLeft:($(window).width()-237*g)/2});for(var h=[],d=0;d<g;d++)c=$("<div/>").css({width:222,cssFloat:"left",marginLeft:15}),0==d&&c.css({marginLeft:0}),h.push(c),$("#wr").append(c);$("#wr").append($("<div/>").css({clear:"both",cssFloat:"none"}));var j=0,k=(window.location.search.match(/query=(.*?)(&|$)/)||[])[1],r=window.location.pathname.match(/(\w{3})\/?$/)[1],
